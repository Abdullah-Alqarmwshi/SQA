            ...
            <div class="modal-content message-modal-content">
                ...
                <div class="modal-body message-modal-body">
                    <div class="view-message-content">
                        <div class="mb-3">
                            <label class="form-label text-muted"><i class="fas fa-user"></i> Author</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label text-muted"><i class="fas fa-info-circle"></i> Category</label>
            ...
            <div class="modal-content message-modal-content">
                ...
                <form method="POST" id="editMessageForm">
                    ...
                    <div class="modal-footer message-modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary btn-send-message">
                            <i class="fas fa-check-circle"></i> Update Message
                        </button>
                    </div>
                </form>
            </div>
